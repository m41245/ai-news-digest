...
class ArticleCompanyModel(Base):
    ...
    article: Mapped[ArticleModel] = relationship(back_populates="company_links", lazy="selectin")
    company: Mapped[CompanyModel] = relationship(back_populates="article_links", lazy="selectin")
