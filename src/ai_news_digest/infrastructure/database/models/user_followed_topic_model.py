...
class UserFollowedTopicModel(Base):
    ...
    user: Mapped[UserModel] = relationship(back_populates="followed_topics", lazy="selectin")
    topic: Mapped[TopicModel] = relationship(back_populates="followed_by_users", lazy="selectin")
