...
class UserMutedCategoryModel(Base):
    __tablename__ = "user_muted_categories"
    ...
    user: Mapped[UserModel] = relationship(back_populates="muted_categories", lazy="selectin")
    category: Mapped[CategoryModel] = relationship(back_populates="muted_by_users", lazy="selectin")
