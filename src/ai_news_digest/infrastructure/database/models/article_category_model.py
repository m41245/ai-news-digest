...
class ArticleCategoryModel(Base):
    ...
    article: Mapped[ArticleModel] = relationship(back_populates="category_links", lazy="selectin")
    category: Mapped[CategoryModel] = relationship(back_populates="article_links", lazy="selectin")
